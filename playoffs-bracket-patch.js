// ==========================================
// PATCH: Bracket de Play-Offs (SIN botones)
...
(function () {
  ...
  // ---------- Render de un partido individual (sin acciones) ----------
  function renderBracketMatchPatch(match, torneo, roundIndex, matchIndex, isFinal, pcLayout) {
    ...
    if (pcLayout) {
      // Layout PC: 1 sola fila (home | score | away)
      return `
      ...
      // Layout móvil: 2 filas (home arriba, away abajo)
      return `
        <div class="bracket-match ${isFinal ? 'bracket-match-final' : ''}">
          <div class="bracket-team bracket-team-home ${hWinner ? 'winner' : ''}">
            ${hShieldHtml}
  ...
  console.log('✅ Patch de Play-Offs cargado (bracket espejado + lineal, SIN botones).');
})();